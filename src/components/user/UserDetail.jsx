            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="bg-light p-4">
                    <div className="mb-3">
                        ...
                        <input defaultValue={userInfo.name} type="text" id="fullname" className="form-control" 
                            {...register("name")}
                        />
                    </div>
                    <div className="mb-3">
                        <label className="col-form-label">Email</label>
                        <input defaultValue={userInfo.email} type="text" id="email" className="form-control"  
                            {...register("email")}
                    ...
                    <div className="mb-3">
                        ...
                        <input defaultValue={userInfo.phone} type="text" id="phone" className="form-control" 
                            {...register("phone")}
                        />
                    </div>
                    <div className="mb-3">
                ...
                <div className="text-center mt-3">
                    <button className="btn btn-secondary btn-back" onClick={() => navigate("/")}>Quay lại</button>
                    <button className="btn btn-success" type = "submit" id="btn-save">Cập nhật</button>
                </div>
            </form>
            </div>
        </div>
